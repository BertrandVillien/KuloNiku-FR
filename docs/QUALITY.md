...
La limite reste un garde-fou : le maximum de caractères observé parmi les huit
langues officielles, pas la largeur réelle en pixels. Les dépassements conservés
seront vérifiés en jeu, notamment les nouveaux modes Endless et les noms de
recettes longs.

## Arbitrages éditoriaux

Les entrées auparavant provisoires ont été arbitrées après le premier test en
jeu. Les contrôles visuels et les retours de partie restent néanmoins
indispensables.
