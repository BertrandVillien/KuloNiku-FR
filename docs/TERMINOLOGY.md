...
Ce glossaire fixe les choix répétés afin que les contributions restent
cohérentes. Il ne reproduit pas les textes source du jeu.

## Cuisine

| Concept | Français retenu | Note |
|---|---|---|
| meatball | boulette | Ingrédient générique. |
| fish balls | boulettes de poisson | Ne pas confondre avec le narutomaki. |
| bakso urat | boulette de tendon | Conserver le sens de `bakso`. |
...
| ice, dans une boisson | glaçons | Évite l'ambiguïté avec une crème glacée. |

## Stations et interface
